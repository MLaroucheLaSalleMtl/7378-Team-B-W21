        ...
        if(other.tag=="Dead")
        {
            ...
            if(enemy!=null)
            {
                ...
                if (enemy.EnemyType == Enemy.enemy_type.Skeleton)
                {
                    ...
                    GameObject GhostEnemy = Instantiate(Ghost, enemy.transform.position, Quaternion.identity);
                    GhostEnemy.GetComponent<Enemy>().GetMovingValueFromOthers(enemy);
                ...
                {
                    GameObject GhostEnemy_Archer = Instantiate(Ghost_Archer, enemy.transform.position, Quaternion.identity);
                    GhostEnemy_Archer.GetComponent<Enemy>().GetMovingValueFromOthers(enemy);
                }
